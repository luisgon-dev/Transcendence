...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddTranscendenceCore(this IServiceCollection services)
    {
        ...
        // Its only consumer is the Build Lab refresh job; the worker host resolves it at startup so the
        // series exist and read 0 instead of being absent. See Service/Program.cs.
        ...
        services.AddScoped<IBuildLabStatsRefresher, BuildLabStatsRefresher>();
        ...
        IConfiguration configuration)
    {
        ...
        // League-V4 entries read over Camille's transport but deserialized enum-free, because Riot keeps
        // extending queueType beyond the schema Camille generates from. See ILeagueEntriesClient.
        services.AddScoped<ILeagueEntriesClient, CamilleLeagueEntriesClient>();
