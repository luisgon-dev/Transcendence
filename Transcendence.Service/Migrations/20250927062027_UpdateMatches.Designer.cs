...
namespace Transcendence.Service.Migrations
{
    ...
    [Migration("20250927062027_UpdateMatches")]
            ...
            modelBuilder.Entity("Transcendence.Data.Models.LoL.Match.Runes", b =>
                {
                    ...
                    b.PrimitiveCollection<int[]>("RuneVars0")
                        .IsRequired()
                        .HasColumnType("integer[]");

                    b.PrimitiveCollection<int[]>("RuneVars1")
                        .IsRequired()
                        .HasColumnType("integer[]");

                    b.PrimitiveCollection<int[]>("RuneVars2")
                        .IsRequired()
                        .HasColumnType("integer[]");

                    b.PrimitiveCollection<int[]>("RuneVars3")
                        .IsRequired()
                        .HasColumnType("integer[]");

                    b.PrimitiveCollection<int[]>("RuneVars4")
                        .IsRequired()
                        .HasColumnType("integer[]");

                    b.PrimitiveCollection<int[]>("RuneVars5")
                        .IsRequired()
                        .HasColumnType("integer[]");
                    ...
                    b.HasIndex("PrimaryStyle", "SubStyle", "Perk0", "Perk1", "Perk2", "Perk3", "Perk4", "Perk5", "StatDefense", "StatFlex", "StatOffense")
