...
const QUICK_LINKS = [
  { label: "S Tier", href: "/lol/tierlist" },
  { label: "Best Top", href: "/lol/tierlist?role=TOP" },
  { label: "Best Jungle", href: "/lol/tierlist?role=JUNGLE" },
  { label: "Best Mid", href: "/lol/tierlist?role=MIDDLE" },
  { label: "Best Bot", href: "/lol/tierlist?role=BOTTOM" },
  { label: "Best Support", href: "/lol/tierlist?role=UTILITY" }
] as const;
      ...
      <section className="grid gap-4 lg:grid-cols-[1.5fr_1fr]">
        ...
        <div className="grid gap-4">
          ...
          <Card className="border-primary/45 bg-gradient-to-br from-primary/15 to-primary-2/10 p-5">
            ...
            <Link
              href={`/lol/pro-builds/222${activeRegion !== "ALL" ? `?region=${encodeURIComponent(activeRegion)}` : ""}`}
