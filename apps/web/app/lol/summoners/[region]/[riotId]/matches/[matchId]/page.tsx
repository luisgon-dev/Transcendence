...
export default async function SummonerMatchDetailsRedirectPage({
  params,
  searchParams
}: {
  ...
  qs.set("expandMatchId", resolvedParams.matchId);

  redirect(`/lol/summoners/${encodeURIComponent(resolvedParams.region)}/${canonical}?${qs.toString()}`);
}
